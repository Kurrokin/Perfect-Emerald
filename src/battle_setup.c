...
// ============================================================================
// Per-map battle environment overrides (HnS-style sMapDefaultEnvironments)
// ----------------------------------------------------------------------------
// Checked before metatile/map-type detection, so a specific location can force
// an environment that terrain sniffing would otherwise get wrong -- e.g. Shoal
// Cave's ice room reading as a plain cave. Add a row to extend.
// ============================================================================
static const struct {
    u16 mapId;
    u8 environment;
    ...
    // --- icy caves ---
    {MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM,              BATTLE_TERRAIN_SNOW_CAVE},

    // --- water inside caves ---
    {MAP_SHOAL_CAVE_LOW_TIDE_LOWER_ROOM,            BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SHOAL_CAVE_LOW_TIDE_INNER_ROOM,            BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM1,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM2,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM3,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM4,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM5,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM6,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM7,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM8,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_SEAFLOOR_CAVERN_ROOM9,                     BATTLE_TERRAIN_CAVE_WATER},
    {MAP_CAVE_OF_ORIGIN_B1F,                        BATTLE_TERRAIN_CAVE_WATER},
    {MAP_MARINE_CAVE_ENTRANCE,                      BATTLE_TERRAIN_CAVE_WATER},
    {MAP_MARINE_CAVE_END,                           BATTLE_TERRAIN_CAVE_WATER},

    // --- lava caves (HnS volcano cave) ---
    {MAP_FIERY_PATH,                                BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_1F,                          BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_2F_1R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_2F_2R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_2F_3R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_3F_1R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_3F_1R_ENTEI,                 BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_3F_1R_MODERN,                BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_3F_2R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_3F_3R,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_MAGMA_HIDEOUT_4F,                          BATTLE_TERRAIN_VOLCANO},
    {MAP_TERRA_CAVE_ENTRANCE,                       BATTLE_TERRAIN_VOLCANO},
    {MAP_TERRA_CAVE_END,                            BATTLE_TERRAIN_VOLCANO},

    // --- volcanic outdoors (were using the lava-CAVE art before) ---
    {MAP_MT_CHIMNEY,                                BATTLE_TERRAIN_CRATER},
    {MAP_JAGGED_PASS,                               BATTLE_TERRAIN_ASH},
    {MAP_ROUTE113,                                  BATTLE_TERRAIN_ASH},

    // --- forest ---
    {MAP_PETALBURG_WOODS,                           BATTLE_TERRAIN_FOREST},

    // --- Mt. Pyre ---
    {MAP_MT_PYRE_EXTERIOR,                          BATTLE_TERRAIN_GRAVEYARD},
    {MAP_MT_PYRE_SUMMIT,                            BATTLE_TERRAIN_GRAVEYARD},
    {MAP_MT_PYRE_1F,                                BATTLE_TERRAIN_TOMB_HALL},
    {MAP_MT_PYRE_2F,                                BATTLE_TERRAIN_TOMB_HALL},
    {MAP_MT_PYRE_3F,                                BATTLE_TERRAIN_TOMB_HALL},
    {MAP_MT_PYRE_4F,                                BATTLE_TERRAIN_TOMB_HALL},
    {MAP_MT_PYRE_5F,                                BATTLE_TERRAIN_TOMB_HALL},
    {MAP_MT_PYRE_6F,                                BATTLE_TERRAIN_TOMB_HALL},

    // --- ancient ruins ---
    {MAP_SKY_PILLAR_1F,                             BATTLE_TERRAIN_RUINS},
    {MAP_SKY_PILLAR_2F,                             BATTLE_TERRAIN_RUINS},
    {MAP_SKY_PILLAR_3F,                             BATTLE_TERRAIN_RUINS},
    {MAP_SKY_PILLAR_4F,                             BATTLE_TERRAIN_RUINS},
    {MAP_SKY_PILLAR_5F,                             BATTLE_TERRAIN_RUINS},
    {MAP_DESERT_RUINS,                              BATTLE_TERRAIN_RUINS},
    {MAP_ISLAND_CAVE,                               BATTLE_TERRAIN_RUINS},
    {MAP_ANCIENT_TOMB,                              BATTLE_TERRAIN_RUINS},
    {MAP_SEALED_CHAMBER_OUTER_ROOM,                 BATTLE_TERRAIN_RUINS},
    {MAP_SEALED_CHAMBER_INNER_ROOM,                 BATTLE_TERRAIN_RUINS},
    {MAP_MIRAGE_TOWER_1F,                           BATTLE_TERRAIN_RUINS},
    {MAP_MIRAGE_TOWER_2F,                           BATTLE_TERRAIN_RUINS},
    {MAP_MIRAGE_TOWER_3F,                           BATTLE_TERRAIN_RUINS},
    {MAP_MIRAGE_TOWER_4F,                           BATTLE_TERRAIN_RUINS},

    // --- Abandoned Ship (underwater rooms keep the underwater art) ---
    {MAP_ABANDONED_SHIP_DECK,                       BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_CORRIDORS_1F,               BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_ROOMS_1F,                   BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_CORRIDORS_B1F,              BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_ROOMS_B1F,                  BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_ROOMS2_B1F,                 BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_ROOM_B1F,                   BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_ROOMS2_1F,                  BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_CAPTAINS_OFFICE,            BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_HIDDEN_FLOOR_CORRIDORS,     BATTLE_TERRAIN_SHIP},
    {MAP_ABANDONED_SHIP_HIDDEN_FLOOR_ROOMS,         BATTLE_TERRAIN_SHIP},

    // --- New Mauville ---
    {MAP_NEW_MAUVILLE_ENTRANCE,                     BATTLE_TERRAIN_POWER_PLANT},
    {MAP_NEW_MAUVILLE_INSIDE,                       BATTLE_TERRAIN_POWER_PLANT},
    {MAP_NEW_MAUVILLE_INSIDE_RAIKOU,                BATTLE_TERRAIN_POWER_PLANT},
    {MAP_NEW_MAUVILLE_INSIDE_MODERN,                BATTLE_TERRAIN_POWER_PLANT},

    // --- battle facilities ---
    {MAP_BATTLE_FRONTIER_BATTLE_TOWER_BATTLE_ROOM,  BATTLE_TERRAIN_BLUE_BUILDING},
    {MAP_BATTLE_FRONTIER_BATTLE_DOME_BATTLE_ROOM,   BATTLE_TERRAIN_BLUE_BUILDING},
    {MAP_BATTLE_FRONTIER_BATTLE_PALACE_BATTLE_ROOM, BATTLE_TERRAIN_BLUE_BUILDING},
    {MAP_BATTLE_FRONTIER_BATTLE_ARENA_BATTLE_ROOM,  BATTLE_TERRAIN_BLUE_BUILDING},
    {MAP_BATTLE_FRONTIER_BATTLE_FACTORY_BATTLE_ROOM, BATTLE_TERRAIN_BLUE_BUILDING},

    // BATTLE_TERRAIN_SNOW and BATTLE_TERRAIN_ROCK_SNOW are loaded and ready
    // (with morning/day/night palettes); Hoenn has no snowfield, so assign
    // them here to any map you add.
};

static bool8 GetMapDefaultEnvironment(u8 *environment)
{
    u16 mapId = (gSaveBlock1Ptr->location.mapNum)
              | (gSaveBlock1Ptr->location.mapGroup << 8);
    u32 i;

    for (i = 0; i < ARRAY_COUNT(sMapDefaultEnvironments); i++)
    {
        if (sMapDefaultEnvironments[i].mapId == mapId)
        {
            *environment = sMapDefaultEnvironments[i].environment;
            return TRUE;
        }
    }
    return FALSE;
...
// Area environment
// ----------------------------------------------------------------------------
// Wild battles start on the tile that triggered them (grass, sand, water...),
// so they already get the right background. Trainer battles and fishing
// usually start on a plain path tile, which used to fall through to the
// "plain" background. Instead, look at the terrain around the player and use
// the background a wild battle in this spot would have had.
// ============================================================================
#define AREA_SCAN_RADIUS    7
#define AREA_SCAN_MIN_SCORE 10

static u8 GetTerrainFromBehavior(u16 behavior)
{
...
// Trainer battles fought on land (not surfing / not standing in water).
static bool8 IsTrainerBattleOnLand(void)
{
    s16 x, y;
    u16 behavior;
...
static bool8 IsOutdoorMapType(u8 mapType)
{
    return mapType == MAP_TYPE_TOWN || mapType == MAP_TYPE_CITY
        || mapType == MAP_TYPE_ROUTE || mapType == MAP_TYPE_OCEAN_ROUTE;
}

static u8 GetAreaEnvironment(s16 px, s16 py)
{
    u16 score[BATTLE_TERRAIN_PLAIN + 1] = {0};
    bool8 landOnly = IsTrainerBattleOnLand(); // trainers on land never get sea/lake art
    s16 dx, dy;
    u8 terrain, best = BATTLE_TERRAIN_PLAIN;

    // Fishing: the water you cast into decides.
    if (gIsFishingEncounter)
    {
        s16 fx = px, fy = py;
        MoveCoords(GetPlayerFacingDirection(), &fx, &fy);
        terrain = GetTerrainFromBehavior(MapGridGetMetatileBehaviorAt(fx, fy));
        if (terrain == BATTLE_TERRAIN_WATER || terrain == BATTLE_TERRAIN_POND)
            return terrain;
    }

    for (dy = -AREA_SCAN_RADIUS; dy <= AREA_SCAN_RADIUS; dy++)
    {
        for (dx = -AREA_SCAN_RADIUS; dx <= AREA_SCAN_RADIUS; dx++)
        {
            u16 dist = max(abs(dx), abs(dy));
            terrain = GetTerrainFromBehavior(MapGridGetMetatileBehaviorAt(px + dx, py + dy));
            if (landOnly && (terrain == BATTLE_TERRAIN_WATER || terrain == BATTLE_TERRAIN_POND))
                continue;
            if (terrain != BATTLE_TERRAIN_PLAIN)
                score[terrain] += AREA_SCAN_RADIUS + 1 - dist; // nearer tiles count more
        }
    }

    for (terrain = 0; terrain < BATTLE_TERRAIN_PLAIN; terrain++)
    {
        if (score[terrain] > score[best] || (best == BATTLE_TERRAIN_PLAIN && score[terrain] > 0))
            best = terrain;
    }
    if (best != BATTLE_TERRAIN_PLAIN && score[best] < AREA_SCAN_MIN_SCORE)
        best = BATTLE_TERRAIN_PLAIN;
    return best;
}

// Map-specific refinements applied on top of the tile-based result.
static u8 RefineTerrainForMap(u8 terrain)
{
    u16 mapId = (gSaveBlock1Ptr->location.mapNum) | (gSaveBlock1Ptr->location.mapGroup << 8);

    // Route 111's sand is desert, not beach.
    if (terrain == BATTLE_TERRAIN_SAND && mapId == MAP_ROUTE111)
        return BATTLE_TERRAIN_DESERT;
    return terrain;
}

static u8 GetBaseTerrainId(void);

u8 BattleSetup_GetTerrainId(void)
{
    u8 terrain = RefineTerrainForMap(GetBaseTerrainId());

    // A trainer battle on land never shows the lake / ocean background.
    if ((terrain == BATTLE_TERRAIN_WATER || terrain == BATTLE_TERRAIN_POND)
     && IsTrainerBattleOnLand())
        terrain = BATTLE_TERRAIN_PATH;

    // Snow covers the ground outside: land battles use the snowy backgrounds.
    if (GetCurrentWeather() == WEATHER_SNOW && MapHasNaturalLight(gMapHeader.mapType))
    {
        switch (terrain)
        {
        ...
        case BATTLE_TERRAIN_FOREST:
            terrain = BATTLE_TERRAIN_SNOW;
            break;
        case BATTLE_TERRAIN_MOUNTAIN:
            terrain = BATTLE_TERRAIN_ROCK_SNOW;
            break;
        }
    }
    return terrain;
...
static u8 GetBaseTerrainId(void)
{
    ...
    // Per-map override wins over terrain sniffing.
    if (GetMapDefaultEnvironment(&mapEnvironment))
    ...
    case MAP_TYPE_OCEAN_ROUTE:
        if (MetatileBehavior_IsSurfableWaterOrUnderwater(tileBehavior))
            return BATTLE_TERRAIN_WATER;
        {
            // Beach / island patch on a sea route: use the surroundings.
            u8 area = GetAreaEnvironment(x, y);
            if (area == BATTLE_TERRAIN_PLAIN)
                return IsTrainerBattleOnLand() ? BATTLE_TERRAIN_PATH : BATTLE_TERRAIN_SAND;
            return area;
        }
    }
    ...
    if (gSaveBlock1Ptr->location.mapGroup == MAP_GROUP(ROUTE113) && gSaveBlock1Ptr->location.mapNum == MAP_NUM(ROUTE113))
        return BATTLE_TERRAIN_ASH;

    // Trainer battles / fishing on a path: take the area's wild-battle look.
    {
        u8 area = GetAreaEnvironment(x, y);
        if (area != BATTLE_TERRAIN_PLAIN)
            return area;
    ...
    // Outdoor trainer battle with no wild-Pokemon terrain nearby: path.
    if (IsTrainerBattleOnLand() && IsOutdoorMapType(gMapHeader.mapType))
