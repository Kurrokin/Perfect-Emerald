...
void AnimTask_SetCamouflageBlend(u8 taskId)
{
    ...
    case BATTLE_TERRAIN_SNOW_CAVE:
        gBattleAnimArgs[4] = RGB(26, 29, 31);
        break;
    ...
    case BATTLE_TERRAIN_CRATER:
        gBattleAnimArgs[4] = RGB(29, 12, 4);
        break;
    case BATTLE_TERRAIN_FOREST:
        gBattleAnimArgs[4] = RGB(6, 18, 6);
        break;
    case BATTLE_TERRAIN_DESERT:
        gBattleAnimArgs[4] = RGB(30, 24, 11);
        break;
    case BATTLE_TERRAIN_ASH:
        gBattleAnimArgs[4] = RGB(24, 24, 23);
        break;
    case BATTLE_TERRAIN_GRAVEYARD:
    case BATTLE_TERRAIN_TOMB_HALL:
        gBattleAnimArgs[4] = RGB(16, 12, 20);
        break;
    case BATTLE_TERRAIN_RUINS:
        gBattleAnimArgs[4] = RGB(22, 18, 12);
        break;
    case BATTLE_TERRAIN_POWER_PLANT:
        gBattleAnimArgs[4] = RGB(30, 26, 8);
        break;
    default:
        gBattleAnimArgs[4] = RGB_WHITE;
        break;
