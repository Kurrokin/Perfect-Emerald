...
// FIX: Routes 119 and 123 use WEATHER_DYNAMIC now. These specials still ran
// on every entry from indoors (Weather Institute, houses, Fly, Continue-warp)
// and replaced the dynamic weather with the old 4-day cycle, which also took
// control away from the dynamic system until you left the route.
