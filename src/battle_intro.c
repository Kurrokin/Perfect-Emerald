...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    [BATTLE_TERRAIN_ROCK_SNOW]     = BattleIntroSlide1,
    [BATTLE_TERRAIN_SNOW_CAVE]     = BattleIntroSlide1,
    ...
    [BATTLE_TERRAIN_DESERT]        = BattleIntroSlide1,
    [BATTLE_TERRAIN_ASH]           = BattleIntroSlide1,
    [BATTLE_TERRAIN_CRATER]        = BattleIntroSlide1,
    [BATTLE_TERRAIN_GRAVEYARD]     = BattleIntroSlide1,
    [BATTLE_TERRAIN_TOMB_HALL]     = BattleIntroSlide3,
    [BATTLE_TERRAIN_RUINS]         = BattleIntroSlide3,
    [BATTLE_TERRAIN_SHIP]          = BattleIntroSlide3,
    [BATTLE_TERRAIN_POWER_PLANT]   = BattleIntroSlide3,
    [BATTLE_TERRAIN_PATH]          = BattleIntroSlide1, // same art/entry as tall grass
};
...
void HandleIntroSlide(u8 terrain)
{
    ...
    else
    {
        if (gSaveBlock2Ptr->optionsFastIntro == 1)
        {
            if (terrain >= ARRAY_COUNT(sBattleIntroSlideFuncs) || sBattleIntroSlideFuncs[terrain] == NULL)
