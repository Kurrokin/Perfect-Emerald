...
#define WEATHER_MIST                    16  // Copy of horizontal fog: no shading, 85% more transparent
#define WEATHER_ROUTE119_CYCLE          20
#define WEATHER_ROUTE123_CYCLE          21
#define WEATHER_DYNAMIC                 22
...
#define COORD_EVENT_WEATHER_DYNAMIC             22 // restore the map's dynamic weather
