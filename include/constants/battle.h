...
#define BATTLE_TERRAIN_ROCK_SNOW     11
#define BATTLE_TERRAIN_SNOW_CAVE     12
#define BATTLE_TERRAIN_CAVE_WATER    13
#define BATTLE_TERRAIN_VOLCANO       14
#define BATTLE_TERRAIN_BLUE_BUILDING 15
// Hoenn locations with no dedicated HnS/expansion background. They use the
// closest HnS art; gameplay effects (Nature Power, Camouflage, Secret Power,
// intro slide) are set per terrain.
#define BATTLE_TERRAIN_FOREST        16 // Petalburg Woods
#define BATTLE_TERRAIN_DESERT        17 // Route 111 desert, Mirage Tower
#define BATTLE_TERRAIN_ASH           18 // Route 113, Jagged Pass
#define BATTLE_TERRAIN_CRATER        19 // Mt. Chimney summit
#define BATTLE_TERRAIN_GRAVEYARD     20 // Mt. Pyre exterior / summit
#define BATTLE_TERRAIN_TOMB_HALL     21 // Mt. Pyre interior floors
#define BATTLE_TERRAIN_RUINS         22 // Sky Pillar, Desert Ruins, Island Cave, Ancient Tomb, Sealed Chamber
#define BATTLE_TERRAIN_SHIP          23 // Abandoned Ship
#define BATTLE_TERRAIN_POWER_PLANT   24 // New Mauville
#define BATTLE_TERRAIN_PATH          25 // Outdoor trainer battles on a path (copy of the tall grass art)
