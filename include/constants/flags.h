...
#define FLAG_OWE_ON  0x289 // OWE option: overworld wild encounters on
#define FLAG_OWE_RESTRICT  0x28A // OWE option: Restrict (they stay in the grass)
#define FLAG_BATTLE_SHADOWS_OFF  0x28B // SHADOWS option = Off
#define FLAG_UNUSED_0x28C  0x28C // Unused Flag
#define FLAG_UNUSED_0x28D  0x28D // Unused Flag
#define FLAG_BATTLE_TERRAIN_CIRCLES_OFF  0x28E // BATTLE TERRAIN option = Without (no terrain circles)
#define FLAG_DYNAMIC_WEATHER_OVERRIDDEN  0x28F // Set while a script / coord event owns the weather on a WEATHER_DYNAMIC map (saved, so it survives Continue)
#define FLAG_CFRU_BATTLE_BACKGROUNDS  0x290 // BATTLE TERRAIN option = CFRU (with optionsNewBackgrounds = 1)
#define FLAG_PERFECT_BATTLE_BACKGROUNDS  0x291 // BATTLE BACKGROUND option = Perfect
